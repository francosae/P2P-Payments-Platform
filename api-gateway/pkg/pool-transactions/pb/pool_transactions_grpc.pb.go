...
type PoolTransactionsServiceClient interface {
	...
	GetPoolOverview(ctx context.Context, in *GetPoolOverviewRequest, opts ...grpc.CallOption) (*GetPoolOverviewResponse, error)
	// Transactions
...
func (c *poolTransactionsServiceClient) GetPoolOverview(ctx context.Context, in *GetPoolOverviewRequest, opts ...grpc.CallOption) (*GetPoolOverviewResponse, error) {
	out := new(GetPoolOverviewResponse)
...
type PoolTransactionsServiceServer interface {
	...
	GetPoolOverview(context.Context, *GetPoolOverviewRequest) (*GetPoolOverviewResponse, error)
	// Transactions
...
func (UnimplementedPoolTransactionsServiceServer) GetPoolOverview(context.Context, *GetPoolOverviewRequest) (*GetPoolOverviewResponse, error) {
...
func _PoolTransactionsService_GetPoolOverview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PoolTransactionsServiceServer).GetPoolOverview(ctx, req.(*GetPoolOverviewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PoolTransactionsService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/pool-transactions/pb/pool_transactions.proto",
}
